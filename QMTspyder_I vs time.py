...
class CurrentMeter:
    ...
    def configure(self):
        ...
        commands = [
            ...
            'SENSe:FUNCtion "VOLT:DC"',      # *** CHANGED THIS LINE ***
            'SENSe:VOLTage:RANGe:AUTO ON', # Use VOLTage for voltage settings
...
def run_measurement(duration=100000, interval=1):
    with measurement_session() as manager:
        yoko1 = VoltageController(manager.open_instrument(1, "YOKOgate1"), "YOKOgate1")
        yoko2 = VoltageController(manager.open_instrument(2, "YOKOgate2"), "YOKOgate2")
