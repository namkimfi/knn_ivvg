...
def main():
    ...
    start_voltage1, step_size1, delay1 = -0.0, 0.05, 0.1 #n
    start_voltage2, step_size2, delay2 = -0.0, 0.05, 0.1 #x
    start_voltage3, step_size3, delay3 = 0.0, 0.05, 0.05 #TR
    start_voltage4, step_size4, delay4 = 0.0, 0.05, 0.1  #sd
    start_voltage5, step_size5, delay5 = 0.0, 0.05, 0.1  #pl
    
    target_voltage1, step_size0, delay0 = -0.0, 0.05, 0.1  #n
    target_voltage2, step_size02, delay02 = -0.0, 0.05, 0.1 #x
