...
def main():
    ...
    # Save data to file
    fname = 'xxxdata_IVg-0x3-0x5TR_0x2mVsd-4K_202502081220.txt'
    lines_to_append = []
    ...
    for V2, voltages, currents in all_results:
        ...
        plt.plot(voltages, currents, label=f'V2 = {V2:.2f} V')
    
    plt.title("xxxdata_IVg-0x3-0x5TR_0x2mVsd-4K_202502081220")
    plt.xlabel("V_ENT (V)")
