...
def main(jter):
   instrument1 = open_resource(yokoid10) 
   instrument2 = open_resource(yokoid4) 
   ...
   start_voltage1, step_size1, delay1 = -1.0, 0.05, 0.2 #ENT
   ...
   target_voltage1, step_size0, delay0 = 1, 0.02, 0.2  #ENT
   ...
   for V2 in V2_values:
    ...
    # Save data to file
   fname = 'D6-Vs_4K_iter3_231725.txt'
   lines_to_append = []
