...
# GPIB addresses
yokoid1 = "GPIB43::2::INSTR"
yokoid2 = "GPIB43::10::INSTR"
yokoid3 = "GPIB43::5::INSTR"
yokoid4 = "GPIB43::7::INSTR"
yokoid5 = "GPIB43::6::INSTR"
...
def sweep_V1_for_fixed_V2(instrument1, instrument2, V1_start, V1_end, V1_step, V2_value, delay):
    sweep_V2(instrument2, present_voltage(instrument2), V2_value, 0.1, delay)
...
def main():
    ...
    start_voltage1, step_size1, delay1 = -0.0, 0.05, 0.2 #n
    start_voltage2, step_size2, delay2 = -0.0, 0.05, 0.2 #x
    start_voltage3, step_size3, delay3 = 0.0, 0.05, 0.05 #TR
    start_voltage4, step_size4, delay4 = 0.0, 0.05, 0.2  #sd
    start_voltage5, step_size5, delay5 = 0.0, 0.05, 0.2  #pl
    
    target_voltage1, step_size0, delay0 = -0.0, 0.05, 0.2  #n
    target_voltage2, step_size02, delay02 = -0.0, 0.2, 0.2 #x
    ...
    plt.title("Current vs Voltage for Different V_sd Values, V_TR=350 mV")
    plt.xlabel("V_ENT (V)")
