...
def main():
    ...
    instrument3 = open_resource(yokoid2) #pl
    instrument4 = open_resource(yokoid3) #n
    ...
    start_voltage1, step_size1, delay1 = -0.6, 0.05, 0.2 #scan
    ...
    target_voltage1, step_size0, delay0 = -2.0, 0.02, 0.2  #scan
    target_voltage2, step_size02, delay02 = 0.5, 0.1, 0.2 #Tstep
    ...
    windup_voltage(instrument5, start_voltage5, step_size5, delay3) #EXT
    ...
    # Save data to file
    fname = 'data_I-Vx_202507041720.txt'
    lines_to_append = []
