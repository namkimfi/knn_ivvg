...
def main():
    instrument1 = open_resource(yokoid1) 
    instrument2 = open_resource(yokoid2) 
    instrument3 = open_resource(yokoid6) 
    instrument4 = open_resource(yokoid10) 
    instrument5 = open_resource(yokoid3) 
    instrument6 = open_resource(yokoid4) 
    instrument7 = open_resource(yokoid5) 

    start_voltage1, step_size1, delay1 = 0.0, 0.05, 0.2 #ENT
    start_voltage2, step_size2, delay2 = 0.0, 0.05, 0.2 #TR
    start_voltage3, step_size3, delay3 = -0.4, 0.05, 0.05 #Vsd
    start_voltage4, step_size4, delay4 = -1.0, 0.05, 0.05 #pl
    start_voltage5, step_size5, delay5 = 0.0, 0.05, 0.05 #ext
    start_voltage6, step_size6, delay6 = 0, 0.05, 0.05 #ext
    start_voltage7, step_size7, delay7 = 0.0, 0.05, 0.05 #ext

    target_voltage1, step_size0, delay0 = -1.0, 0.02, 0.2  #ENT
    target_voltage2, step_size02, delay02 = -1, -0.2, 0.2 #TR
    ...
    # Save data to file
    fname = 'D7-U1-U2_m0x4L3_m1mVs_231754.txt'
    lines_to_append = []
